# VERIFIED GITHUB DEPLOY FILE — V18.2.3 TWO STRATEGIES ONLY · CLEAN STATS · ACTIVE MOVER GATE FIX
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V18.2.3 TWO STRATEGIES ONLY · CLEAN STATS · ACTIVE MOVER GATE FIX"
DEPLOY_MARKER = "V18_2_3_TWO_STRATEGIES_CLEAN_STATS_ACTIVE_MOVER_GATE_FIX_2026_08_30"
...
def closed_outcome_progress_message(
    ...
    return (
        ...
        f"🔥 4H SQUEEZE: {_metrics_line(exhaust)}\n"
