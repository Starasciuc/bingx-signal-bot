...
TRADER_STYLE_PAPER_REASON = "active_mover_paper_v20_3_5"
...
ACTIVE_MOVER_GUARD_REASON = "active_mover_strategy_guard_v20_3_5"
ACTIVE_RESEARCH_FILTER_REASON = "active_research_filter_v20_3_5"
...
def active_mover_setup(
    ...
    return {
        ...
        "trade_type": f"🧲 SCALP PULLBACK {side}",
...
def process_active_mover_watches() -> Dict[str, int]:
    ...
    """
    stats = {"checked": 0, "triggered": 0, "expired": 0, "rejected": 0, "research_blocked": 0}
    if not ACTIVE_MOVER_ENABLED:
        return stats
