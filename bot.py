# VERIFIED GITHUB DEPLOY FILE — V20.3.6.2 BALANCED MTF · RUNTIME HOTFIX
...
MODEL_DATA_POLICY = "v20_3_spike_regime_forward_only_v1"
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3.6.2 BALANCED MTF · RUNTIME HOTFIX"
DEPLOY_MARKER = "V20_3_6_2_BALANCED_MTF_RUNTIME_HOTFIX_2026_09_04"
...
TRADER_STYLE_PAPER_REASON = "active_mover_paper_v20_3_6_1"
EXHAUSTION_PAPER_REASON = "spike_regime_paper_v20_3_3"
...
SPIKE_ADAPTIVE_BLOCK_REASON = "spike_adaptive_block_v20_3_3"
SPIKE_STRATEGY_GUARD_REASON = "spike_strategy_guard_v20_3_3"
ACTIVE_MOVER_GUARD_REASON = "active_mover_strategy_guard_v20_3_6_1"
ACTIVE_RESEARCH_FILTER_REASON = "active_research_filter_v20_3_6_1"
ACTIVE_MTF_FILTER_REASON = "active_mtf_level_filter_v20_3_6_1"
...
ACTIVE_RESEARCH_SCORE_MIN = float(os.getenv("ACTIVE_RESEARCH_SCORE_MIN", "60"))
...
MTF_A_RESEARCH_MIN = float(os.getenv("MTF_A_RESEARCH_MIN", "56"))
MTF_B_RESEARCH_MIN = float(os.getenv("MTF_B_RESEARCH_MIN", "61"))
...
def active_mover_setup(
    ...
    return {
        ...
        "trade_type": f"🧲 BALANCED MTF {side}",
...
def process_active_mover_watches() -> Dict[str, int]:
    ...
    for item in snapshot:
        ...
        if mtf_tier == "A":
            ...
            required_research = max(ACTIVE_RESEARCH_SCORE_MIN, MTF_B_RESEARCH_MIN)
...
def build_diagnostic(scan: Dict[str, Any]) -> str:
    ...
    return (
        f"🧪 Диагностика V20.3.6.2 BALANCED MTF · 🧲 MTF SCALP + 🚀 SPIKE REGIME\n"
        ...
        f"🧲 BALANCED MTF V20.3.6.1 cohort: {_metrics_line(active_metrics)} · "
        f"n={int(active_metrics.get('n', 0) or 0)}\n"
        f"🚀 SPIKE REGIME V20.3.3: {_metrics_line(spike_metrics)} · "
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"🎯 MTF SCALP TP: {ACTIVE_TP1_MOVE*100:.1f}/{ACTIVE_TP2_MOVE*100:.1f}/"
