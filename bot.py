# VERIFIED GITHUB DEPLOY FILE — V20.3.1 ADAPTIVE PRO · CLEAN DIAGNOSTICS
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3.1 ADAPTIVE PRO · CLEAN DIAGNOSTICS"
DEPLOY_MARKER = "V20_3_1_ADAPTIVE_PRO_CLEAN_DIAGNOSTICS_2026_09_02"
...
TRADER_STYLE_PAPER_REASON = "active_mover_paper_v20_3"
EXHAUSTION_PAPER_REASON = "spike_regime_paper_v20_3"
...
SPIKE_ADAPTIVE_BLOCK_REASON = "spike_adaptive_block_v20_3"
SPIKE_STRATEGY_GUARD_REASON = "spike_strategy_guard_v20_3"
ACTIVE_MOVER_GUARD_REASON = "active_mover_strategy_guard_v20_3"
...
def build_diagnostic(scan: Dict[str, Any]) -> str:
    ...
    return (
        f"🧪 Диагностика V20.3.1 ADAPTIVE PRO · 🧲 ACTIVE MOVER + 🚀 SPIKE REGIME\n"
        ...
        f"🧲 ACTIVE MOVER V20.3: {_metrics_line(active_metrics)} · "
        f"n={int(active_metrics.get('n', 0) or 0)}\n"
        f"🚀 SPIKE REGIME V20.3: {_metrics_line(spike_metrics)} · "
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"Официальные PAPER-линии: 🧲 ACTIVE MOVER + 🚀 SPIKE REGIME V20.3. Legacy Follow-Through/SHADOW отключены.\n"
        ...
        f"🧠 SELF-LEARNING: HARD ENABLED · warm-up {MIN_TRAIN_TRADES} чистых V20.3 SPIKE-кандидатов · retrain каждые {RETRAIN_EVERY} · promotion только после {ADAPTIVE_CONFIRMATION_PASSES} независимых passes · initial canary {ADAPTIVE_INITIAL_LIVE_FRACTION*100:.0f}%.\n"
