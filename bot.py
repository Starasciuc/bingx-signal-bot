# VERIFIED GITHUB DEPLOY FILE — V20.3.2 PRO TRADING INTELLIGENCE · CANDLES + SQUEEZE + ADAPTIVE
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3.2 PRO TRADING INTELLIGENCE · CANDLES + SQUEEZE + ADAPTIVE"
DEPLOY_MARKER = "V20_3_2_PRO_TRADING_INTELLIGENCE_CANDLE_SQUEEZE_ADAPTIVE_2026_09_03"
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"Официальные PAPER-линии: 🧲 ACTIVE MOVER + 🚀 SPIKE REGIME V20.3.2. Legacy Follow-Through/SHADOW отключены.\n"
        ...
        f"🧠 SELF-LEARNING: HARD ENABLED · fresh V20.3.2 cohort · warm-up {MIN_TRAIN_TRADES} · retrain каждые {RETRAIN_EVERY} · 2-pass validation · canary {ADAPTIVE_INITIAL_LIVE_FRACTION*100:.0f}%.\n"
        ...
        f"Diagnostics V20.3.1: current two-lane summary every 12h (2 times/day); no legacy V18/V17 labels.\n"
