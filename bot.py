# VERIFIED GITHUB DEPLOY FILE — V20.1 PRO SPIKE REGIME · REVIEW-50 QUALITY PATCH
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.1 PRO SPIKE REGIME · REVIEW-50 QUALITY PATCH"
DEPLOY_MARKER = "V20_1_PRO_SPIKE_REGIME_REVIEW50_QUALITY_PATCH_2026_08_31"
...
EXHAUSTION_PAPER_REASON = "spike_regime_paper_v20_1"
...
def process_squeeze_exhaustion_watches() -> Dict[str, int]:
    ...
    for item in snapshot:
        ...
        mom1 = percent_change(c1, 1)
        mom3 = percent_change(c1, 3)
        mom5 = percent_change(c1, 5)
        mom15 = percent_change(c5, 3)
        ...
        setup["paper_validation_origin"] = (
            ...
            f"15m aligned={cont_15m_aligned}, overextended={micro_overextended}, failed reclaim={failed_reclaim}, "
            f"mom1 {mom1*100:+.2f}%, mom3 {mom3*100:+.2f}%, Vol1 x{vol1:.2f}."
        )
...
def build_diagnostic(scan: Dict[str, Any]) -> str:
    ...
    return (
        ...
        f"🚀 SPIKE REGIME V19.0: {_metrics_line(exhaust_metrics)} · "
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"Официальные PAPER-линии: 🧲 ACTIVE MOVER + 🚀 SPIKE REGIME V20.1. Legacy Follow-Through/SHADOW отключены.\n"
