# VERIFIED GITHUB DEPLOY FILE — V20.3.3 PRO TRADING INTELLIGENCE · CLEAN STARTUP + 75 WARMUP
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3.3 PRO TRADING INTELLIGENCE · CLEAN STARTUP + 75 WARMUP"
DEPLOY_MARKER = "V20_3_3_PRO_TRADING_INTELLIGENCE_CLEAN_STARTUP_75_2026_09_03"
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"🧲 ACTIVE MOVER: HOT → quiet WATCH → pullback/reclaim → re-acceleration → PAPER.\n"        f"🧲 V20.3.3 ACTIVE MOVER: true 1m/3m/15m/30m returns + pullback/reclaim/re-acceleration + professional candle intelligence + liquidity + symbol/strategy guards.\n"
