...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3.2.2 · REFERENCE SCALP + BLOGGER CONFLUENCE + PRO TRADING INTELLIGENCE"
DEPLOY_MARKER = "V20_3_2_2_REFERENCE_SCALP_BLOGGER_CONFLUENCE_2026_09_08"
...
async def scan_loop():
    ...
    send_telegram(
        ...
        f"Официальные PAPER-линии: 🧲 ACTIVE MOVER + 🚀 SPIKE REGIME V20.3.2.2. Legacy Follow-Through/SHADOW отключены.\n"
        ...
        f"🧠 SELF-LEARNING: HARD ENABLED · fresh V20.3.2.2 cohort · warm-up {MIN_TRAIN_TRADES} · retrain каждые {RETRAIN_EVERY} · 2-pass validation · canary {ADAPTIVE_INITIAL_LIVE_FRACTION*100:.0f}%.\n"
        ...
        f"Diagnostics V20.3.2.2: current two-lane summary every 12h (2 times/day); no legacy V18/V17 labels.\n"
