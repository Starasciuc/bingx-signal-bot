# VERIFIED GITHUB DEPLOY FILE — V20.3 ADAPTIVE PRO · SPIKE REGIME + ACTIVE MOVER
...
APP_NAME = "Professional Adaptive Futures Bot AUTO V20.3 ADAPTIVE PRO · SPIKE REGIME + ACTIVE MOVER"
DEPLOY_MARKER = "V20_3_ADAPTIVE_PRO_SPIKE_REGIME_ACTIVE_MOVER_2026_09_02"
...
def build_diagnostic(scan: Dict[str, Any]) -> str:
    ...
    return (
        ...
        f"🚀 SPIKE REGIME V20.3: {_metrics_line(exhaust_metrics)} · "
